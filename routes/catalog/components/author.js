...
authorRouter.get("/author/create", authorController.author_create_post);
...
authorRouter.post("/author/:id/update", authorController.author_update_post);

// GET request for one Author.
authorRouter.get("/author/:id", authorController.author_detail);
